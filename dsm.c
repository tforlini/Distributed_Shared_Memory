...
char *dsm_init(int argc, char **argv) {
	...
	// Dans dsmwrap on a la socket d'écoute avec listen
	// Il faut faire connect + accept avec tous les autres processus
	// Chaque machine doit effectuer un connect pour la machine 
	// ID+1 et un accept pour la machine ID-1 
